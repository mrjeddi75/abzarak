    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div>
          ...
          <Input value={data.invoiceNumber} onChange={e => update('invoiceNumber', e.target.value)} dir="ltr" className="mt-1" />
        </div>
        <div>
          <Label>تاریخ صدور</Label>
          <Input type="date" value={data.invoiceDate} onChange={e => update('invoiceDate', e.target.value)} dir="ltr" className="mt-1" />
        </div>
        <div>
          <Label>تاریخ سررسید</Label>
          <Input type="date" value={data.dueDate} onChange={e => update('dueDate', e.target.value)} dir="ltr" className="mt-1" />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-lg">اطلاعات صادرکننده</CardTitle>
          </CardHeader>
          <CardContent className="space-y-3">
            <div>
              <Label>نام / شرکت</Label>
              <Input value={data.senderName} onChange={e => update('senderName', e.target.value)} placeholder="نام فروشنده" className="mt-1" />
            </div>
            <div>
              <Label>تلفن</Label>
              <Input value={data.senderPhone} onChange={e => update('senderPhone', e.target.value)} placeholder="شماره تماس" dir="ltr" className="mt-1" />
            </div>
            <div>
              <Label>آدرس</Label>
              <Textarea value={data.senderAddress} onChange={e => update('senderAddress', e.target.value)} placeholder="آدرس" className="mt-1 min-h-[60px]" />
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            <div>
              <Label>نام / شرکت</Label>
              <Input value={data.clientName} onChange={e => update('clientName', e.target.value)} placeholder="نام مشتری" className="mt-1" />
            </div>
            <div>
              <Label>تلفن</Label>
              <Input value={data.clientPhone} onChange={e => update('clientPhone', e.target.value)} placeholder="شماره تماس" dir="ltr" className="mt-1" />
            </div>
            <div>
              <Label>آدرس</Label>
              <Textarea value={data.clientAddress} onChange={e => update('clientAddress', e.target.value)} placeholder="آدرس" className="mt-1 min-h-[60px]" />
            </div>
          </CardContent>
        </Card>
      </div>
      ...
      <Card>
        <CardHeader className="pb-2">
          <div className="flex items-center justify-between">
            <CardTitle className="text-lg">آیتم‌های فاکتور</CardTitle>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-lg">مالیات و تخفیف</CardTitle>
          </CardHeader>
          <CardContent className="space-y-3">
            <div>
              <Label>نرخ مالیات ({toPersianDigits(data.taxRate)}٪)</Label>
              <Input
                type="range"
                min="0"
                max="30"
            ...
            <div>
              <Label>تخفیف ({toPersianDigits(data.discount)}٪)</Label>
              <Input
                type="range"
                min="0"
                max="100"
