...
const componentMap: Record<string, React.LazyExoticComponent<React.ComponentType>> = {
  Calculator: React.lazy(() => import("@/components/tools/calculator")),
  ...
  Salary: React.lazy(() => import("@/components/tools/salary")),
  SalaryTax: React.lazy(() => import("@/components/tools/salary-tax")),
  EidiSanavat: React.lazy(() => import("@/components/tools/eidi-sanavat")),
  Insurance: React.lazy(() => import("@/components/tools/insurance")),
  HousingAllowance: React.lazy(() => import("@/components/tools/housing-allowance")),
  GoldPrice: React.lazy(() => import("@/components/tools/gold-price")),
  ...
  Base64: React.lazy(() => import("@/components/tools/base64")),
  NumberToWords: React.lazy(() => import("@/components/tools/number-to-words")),
  TimezoneConverter: React.lazy(() => import("@/components/tools/timezone-converter")),
  ...
  LetterConverter: React.lazy(() => import("@/components/tools/letter-converter")),
  ...
  ReverseText: React.lazy(() => import("@/components/tools/reverse-text")),
  LineNumbers: React.lazy(() => import("@/components/tools/line-numbers")),
  LoremIpsum: React.lazy(() => import("@/components/tools/lorem-ipsum")),
  JsonFormatter: React.lazy(() => import("@/components/tools/json-formatter")),
  HashGenerator: React.lazy(() => import("@/components/tools/hash-generator")),
  CssMinifier: React.lazy(() => import("@/components/tools/css-minifier")),
  ...
  UrlEncoder: React.lazy(() => import("@/components/tools/url-encoder")),
  HtmlMinifier: React.lazy(() => import("@/components/tools/html-minifier")),
  SqlFormatter: React.lazy(() => import("@/components/tools/sql-formatter")),
  CrontabGenerator: React.lazy(() => import("@/components/tools/crontab-generator")),
  ...
  UnixTimestamp: React.lazy(() => import("@/components/tools/unix-timestamp")),
