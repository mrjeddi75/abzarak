...
export const metadata: Metadata = {
  title: "ابزارک - ابزارهای آنلاین رایگان فارسی | بیش از 30 ابزار",
  description:
    "مجموعه کامل ابزارهای آنلاین رایگان فارسی: ماشین حساب، تقویم شمسی، تبدیل تاریخ، هواشناسی، ابزارهای توسعه‌دهندگان، شبکه، محاسبه مالیات حقوق، عیدی و سنوات و بیش از 30ابزار کاربردی.",
  keywords: [
    "ابزار آنلاین",
    "ماشین حساب",
    "تقویم شمسی",
...
export default function RootLayout({
  ...
  const jsonLd = {
    ...
    url: "https://abzarak.pages.dev",
    description:
      "مجموعه کامل ابزارهای آنلاین رایگان فارسی با بیش از 30 ابزار کاربردی",
    inLanguage: "fa-IR",
    potentialAction: {
      "@type": "SearchAction",
