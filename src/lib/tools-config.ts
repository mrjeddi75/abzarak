...
export const toolCategories: ToolCategory[] = [
  ...
  },
  {
    ...
    tools: [
      ...
      { id: "gold-price", name: "قیمت طلا و سکه", description: "محاسبه قیمت طلا، سکه و جواهرات", icon: "Coins", component: "GoldPrice", seoTip: "محاسبه آنلاین قیمت طلا و سکه بر اساس قیمت لحظه‌ای" },
    ],
  },
  {
    id: "conv",
